...
<div class="col-md-4">
		...
		<div class="controls">
			<fieldset>
				<input type="checkbox" id="checkbox_2" name="board" value="1" {{ $adminuser->board == 1 ? 'checked' : '' }}>
			...
			<fieldset>
				<input type="checkbox" id="checkbox_4" name="project" value="1" {{ $adminuser->project == 1 ? 'checked' : '' }}>
			...
			<fieldset>
				<input type="checkbox" id="checkbox_6" name="blog" value="1" {{ $adminuser->blog == 1 ? 'checked' : '' }}>
...
<div class="col-md-4">
		...
		<div class="controls">
			<fieldset>
				<input type="checkbox" id="checkbox_7" name="banner" value="1" {{ $adminuser->banner == 1 ? 'checked' : '' }}>
				<label for="checkbox_7">Banner</label>
			</fieldset>
			<fieldset>
			...
			<fieldset>
				<input type="checkbox" id="checkbox_10" name="news" value="1" {{ $adminuser->news == 1 ? 'checked' : '' }}>
				<label for="checkbox_10">News</label>
			</fieldset>
			<fieldset>
				<input type="checkbox" id="checkbox_11" name="bannerCategory" value="1" {{ $adminuser->bannerCategory == 1 ? 'checked' : '' }}>
				<label for="checkbox_11">BannerCategory</label>
			</fieldset>
            <fieldset>
