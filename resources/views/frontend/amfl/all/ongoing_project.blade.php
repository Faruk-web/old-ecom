            ...
            <div id="breadcrumbs">
                <div class="breadcrumbs-inner">
                    <div class="breadcrumb-trail">
                        ...
                        <span class="sep">|</span>
                        <span class="trail-end">Ongoing</span>
                        <span class="sep">|</span>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="position-relative">
                                        ...
                                        <h2 class="heading ">All ONGOING PROJECT</h2>
                                        </div>
                                    ...
                                    <!-- /.product-item -->
                                    @php
                                    $project = App\Models\Project::where('status_id','ONGOING')->where('project_type','commercial')->orderBy('id','asc')->limit(12)->get();
                                    @endphp
                                    ...
                                    <!-- /.product-item -->
                                       @php
                                            $project = App\Models\Project::where('status_id','ONGOING')->where('project_type','residential')->orderBy('id','desc')->limit(12)->get();
                                        @endphp
                                         @foreach ($project as $item)
                                        ...
                                        @endforeach
                                        @php
                                        $project = App\Models\Project::where('status_id','ONGOING')->where('project_type','green_house')->orderBy('id','asc')->limit(10)->get();
                                        @endphp
                                        @foreach ($project as $item)
                                        ...
                                        <!-- /.product-item -->
                                        @php
                                        $project = App\Models\Project::where('status_id','ONGOING')->where('project_type','construction')->orderBy('id','asc')->limit(10)->get();
                                        @endphp
                                        @foreach ($project as $item)
                                        ...
                                        <!-- /.product-item -->
                                        @php
                                        $project = App\Models\Project::where('status_id','ONGOING')->where('project_type','architechtur')->orderBy('id','asc')->limit(10)->get();
                                        @endphp
                                        @foreach ($project as $item)
