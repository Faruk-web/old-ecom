                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="themesflat-project style-2 isotope-project has-margin mg15 data-effect clearfix">
                                         ...
                                         <!-- /.product-item -->
                                        @php
                                            $project = App\Models\Project::where('project_type','residential')->orderBy('id','asc')->limit(12)->get();
                                        @endphp
                                         @foreach ($project as $item)
                                        ...
                                        @endforeach
                                        @php
                                        $project = App\Models\Project::where('project_type','green_house')->orderBy('id','asc')->limit(4)->get();
                                        @endphp
                                        @foreach ($project as $item)
                                        ...
                                        <!-- /.product-item -->
                                        @php
                                        $project = App\Models\Project::where('project_type','construction')->orderBy('id','asc')->limit(4)->get();
                                        @endphp
                                        @foreach ($project as $item)
                                        ...
                                        <!-- /.product-item -->
                                        @php
                                        $project = App\Models\Project::where('project_type','architechtur')->orderBy('id','desc')->limit(4)->get();
                                        @endphp
                                        @foreach ($project as $item)
