                ...
                <div id="breadcrumbs">
                    <div class="breadcrumbs-inner">
                        <div class="breadcrumb-trail">
                            ...
                            <span class="sep">|</span>
                            <a href="{{ url('/about') }}" class="trail-begin">About us </a>
                            <span class="sep">|</span>
                            <span class="trail-end">Director</span>
                        </div>
                    </div>
                </div>
            ...
            <div id="site-content" class="site-content clearfix">
                <div id="inner-content" class="inner-content-wrap">
                    ...
                    <div class="themesflat-headings style-2 clearfix">
                        <h2 class="heading">{{ $boardof_directors->director_name }}</h2>
                        <div class="sep has-width w80 accent-bg clearfix"></div>
                        <p class="sub-heading line-height-24 text-777 margin-top-28 margin-right-12">{{ $boardof_directors->director_short_descp}}</p>
                ...
                <div id="inner-sidebar" class="inner-content-wrap">
                        ...
                        <div class="inner">
                            <div class="gallery-item" >
                                <div class="inner">
                                    <div class="thumb">
                                        <img src="{{ asset($boardof_directors->director_image) }}" alt="Image">
                                    </div>
                                </div>
                            </div>
                        </div>
